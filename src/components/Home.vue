    ...
    <v-carousel hide-delimiters>
      ...
      >
        <v-row
          ...
          justify="center"
        >
          <div class="display-2 white--text pl-5 pr-5 hidden-sm-only"><strong>Best for you</strong></div><br/>
        </v-row>
      </v-carousel-item>
      <v-carousel-item
            ...
            <div class="row">
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center">
                ...
                >
                  ...
                  >
                    <v-card-title>vacuum cleaner </v-card-title>
                  </v-img>
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    ...
                    :src="require('../assets/img/home/deal2.jpg')"
                  >
                    <v-card-title>Oven & Toaster </v-card-title>
                  </v-img>
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    ...
                    :src="require('../assets/img/home/deal3.jpg')"
                  >
                    <v-card-title>hair dryer </v-card-title>
                  </v-img>
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  <v-img
                    ...
                    :src="require('../assets/img/home/deal4.jpg')"
                  >
                    <v-card-title>Fan & Air purifier </v-card-title>
                  </v-img>
        ...
        <v-row no-gutters>
          ...
          <v-col class="col-12 col-md-4 col-sm-12">
            <v-row>
              ...
              <v-col  class="col-12 col-sm-9 pr-4">
                <h3 class="font-weight-light">020-123-456-789</h3>
                <p class="font-weight-thin">24/12 Available Support</p>
              </v-col>
            </v-row>
          </v-col>
        </v-row>
